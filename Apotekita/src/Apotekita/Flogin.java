...
public class Flogin extends javax.swing.JFrame {
    ...
    public void cek_login()
    {
        ...
        try
        {
           ...
           String sql="SELECT * FROM user WHERE username='"+user.getText()+"' and password='"+pass.getText()+"' and level='"+level.getSelectedItem()+"'";
            ...
            if (rs.next ())
            {
                if(rs.getString("level").equals("apoteker"))
                {
                    new Futamaapoteker().show();
                    this.dispose();

                }
                else if(rs.getString("level").equals("kepala"))
                {
    ...
    private void initComponents() {
        ...
        level.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "apoteker", "kepala" }));
